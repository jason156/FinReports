...
/**
 * Class FinReports_Uninstall_View
 */
class FinReports_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_finreportscf table
        echo "&nbsp;&nbsp;- Delete vtiger_finreportscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_finreportscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_finreports table
        echo "&nbsp;&nbsp;- Delete vtiger_finreports table.";
        $result = $adb->pquery("DROP TABLE vtiger_finreports");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
